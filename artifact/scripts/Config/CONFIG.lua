Config = {
    ...
    -- Physical Pickup: Add to Inventory (shoulder zone)
    pickupInventoryEnabled = true,        -- When true, releasing item over left shoulder adds it to inventory
